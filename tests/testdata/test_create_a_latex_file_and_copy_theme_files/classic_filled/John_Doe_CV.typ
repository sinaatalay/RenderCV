...
#let connections-list = (
  ...
  [#box(original-link("mailto:john_doe@example.com")[#fa-icon("envelope", size: 0.9em) #h(0.05cm)john_doe\@example.com])],
...
#block(
      #set par(spacing: design-highlights-vertical-space-between-highlights)
#[_Magneto-Thermal Thin Shell Approximation for 3D Finite Element Analysis of No-Insulation Coils_]

#[_J. Doe, #[*_H. Tom_*], S. Doe, A. Andsurname, S. Doe, A. Andsurname, S. Doe, A. Andsurname, S. Doe, A. Andsurname_]

#[_#link("https://doi.org/10.1007/978-3-319-69626-3_101-1")[10.1007/978-3-319-69626-3_101-1]
...
#[_#link("https://example.com")[example.com]
...
_] (IEEE Transactions on Applied Superconductivity),
  breakable: design-entries-allow-page-break-in-entries,
)
#v(design-entries-vertical-space-between-entries)
...
#block(
  two-col-entry(
    left-content: [
      #[_Boğaziçi University_], Mechanical Engineering
